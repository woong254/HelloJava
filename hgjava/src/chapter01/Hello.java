...
public class Hello {
	...
	public static void main(String[] args) {
		...
		char font = 'A';
		int intchar = font + 1;
//		char font2 = intchar;//캐릭터가 인트보다 작아서 안드감
...
//		System.out.println(result);
		...
		boolean result = str1 == str2; // 주소 비교 =>같은 객체인지 확인
		boolean resultobj = str2 == str3;
		System.out.println(result);//같은 객체
		System.out.println(resultobj);//다른 객체
		System.out.println(str2.equals(str3));// 객체데이터 비교			
		...
		// 아니면 ..은 4와 5의 배수 아닙니다 출력
		int su = 20;
		if(su % 4 ==0 && su % 5 == 0) {
			System.out.printf("%d은 4와 5의 배수입니다",su);
		}else {
